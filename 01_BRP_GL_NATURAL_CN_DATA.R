...
files <- list.files(path = "C:/Users/BlueCarbon/Documents/00DeakinUni/R/BCL_R/BCL/BRP/BRP_Gippsland/BRP_GL_NATURAL_RAW",
...
MASTER_DATA <- read.csv("~/00DeakinUni/R/BCL_R/BCL/BRP/BRP_Gippsland/BRP_CN_GL_NATURAL.csv")
NewDATA <- left_join(MASTER_DATA, CN_DATA_clean, by = "CNCode")

dim(MASTER_DATA)# 144  21
dim(NewDATA)#144  25
#write.csv(NewDATA, file = "BRP_CN_GL_NATURAL_NewDATA.csv") # Run and FIND THIS FILE in your working directory
